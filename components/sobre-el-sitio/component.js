...
export default () => (
  <section>
    ...
    <StyledDiv>
      <StaticInfoP>
      El Portal de Colectiva es un desarrollo basado en la tecnología provista por Democracia en Red, coordinado por el Programa de Modernización parlamentaria de la Cámara de Diputados de La Nación.
      </StaticInfoP>
      <StaticInfoP>
